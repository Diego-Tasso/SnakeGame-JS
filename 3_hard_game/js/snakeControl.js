window.onload = function () {
    ...
    var intervaloAtual = setInterval(game, 80); // Intervalo inicial de 100ms
    ...
    function game() {
        ...
        if (score >= 100 && fase === 1) {
            trocarFase(2, 60); // Trocar para a fase 2 com intervalo de 70ms
            fase2.style.display = "block";
        }  
        else if (score >= 150 && fase === 2) {
            trocarFase(3, 40); // Trocar para a fase 3 com intervalo de 60ms
